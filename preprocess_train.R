...
xloc=trunc((traintest$X-min(traintest$X))*cos(pi*y_median/180)/0.005)
yloc=trunc((traintest$Y-min(traintest$Y))/0.005)
...
save(train,file="./data/enhanced/train_sparse.Rdata")
save(Cats,file="./data/enhanced/train_results_sparse.Rdata")
save(test,file="./data/enhanced/test_sparse.Rdata")
