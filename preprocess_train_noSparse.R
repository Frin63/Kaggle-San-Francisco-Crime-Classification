...
train=traintest[1:ntrain,]
test=traintest[(ntrain+1):nrow(traintest),]
rm(traintest)

# Zet de resultaten uit Train over in een apart Sparse maatrix
#Cats=fac2sparse(as.factor(trainCats))
train$Category<-trainCats

# sla de resultaten op
save(train,file="./data/enhanced/train_enhanced.Rdata")
#save(Cats,file="./data/enhanced/train_results_sparse2.Rdata")
save(test,file="./data/enhanced/test_enhanced.Rdata")
